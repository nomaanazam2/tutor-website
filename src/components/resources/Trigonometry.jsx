...
const TrigonometryModal = ({ setOpen = () => {}, open = false }) => {
            ...
            <div className="overflow-y-auto p-6 md:p-8 space-y-8 text-slate-700">
              ...
              <div className="bg-red-50 border border-red-200 rounded-xl p-5">
                ...
                <ul className="space-y-2 text-sm text-red-700">
                  <li>
                    • <strong>Calculator Mode:</strong> Check your screen! If
                    you see 'R' or 'Rad', switch to 'D' or 'Deg'.
                  </li>
                  <li>
                    • <strong>Do NOT use SOH CAH TOA</strong> on non-right
                    angled triangles.
                  </li>
                  <li>
