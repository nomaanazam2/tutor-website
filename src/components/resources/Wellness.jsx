...
const ExamAnxietyModal = ({ handleClose = () => {} }) => {
        ...
        <div className="overflow-y-auto p-6 md:p-8 space-y-10 text-slate-700 custom-scrollbar">
          ...
          <section className="bg-slate-50 rounded-2xl p-6 border border-slate-100">
            ...
            <p className="text-sm text-slate-500 mb-4">
              If your mind goes blank, stop solving. Look around the room and
              find:
            </p>
          ...
          <div className="text-center bg-indigo-50 p-6 rounded-2xl">
            ...
            <p className="text-indigo-600 text-sm mt-2 font-bold">- Samra</p>
          </div>
        </div>
      </div>
    </div>
